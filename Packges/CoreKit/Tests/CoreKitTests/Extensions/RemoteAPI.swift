...
extension RemoteAPI {
    func request<T: Codable>(_ service: RemoteService) async throws -> T {
        ...
        guard let json = Bundle.unitTestForDessertDelightsDessertApiSpy.url(forResource: fileName, withExtension: "json")  else { throw NSError(domain: "json doesnt exist", code: 500) }
        do {
